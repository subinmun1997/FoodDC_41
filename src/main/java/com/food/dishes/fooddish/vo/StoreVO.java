...
public class StoreVO {
    ...
    public StoreVO(int id, UserVO user, StoreCategoryVO category, StoreStateVO state, String businessNumber, String name, String address, String subAddress, double latitude, double longitude, String phone, String operateTime, String photo, String introduction, OpenState openState, String payNumber) {
        super();
        this.id = id;
        this.user = user;
