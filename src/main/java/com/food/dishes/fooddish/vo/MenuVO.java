...
public class MenuVO {
    ...
    public MenuVO(StoreVO store, int id, OfferTypeVO offerType, String tag, String name, int price, int amount, String description, String notice, String photo, Timestamp removeDate) {
        super();
        this.store = store;
        this.id = id;
