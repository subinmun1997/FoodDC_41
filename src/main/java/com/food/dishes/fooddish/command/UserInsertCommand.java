...
public class UserInsertCommand {
    ...
    public UserInsertCommand(String email, String password, String passwordConfirm, String name, String address, String subAddress, String latitude, String longitude, String phone1, String phone2, String phone3, String type) {
        super();
        this.email = email;
