...
import com.food.dishes.fooddish.mapper.OrderMapper;
import com.food.dishes.fooddish.mapper.OrderViewMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    @Override
    public void delete(int orderId) throws OrderException {
        // 향후 구현
    }
    ...
    @Override
    public OrderVO selectById(int orderId) throws OrderException {
    ...
    @Override
    public List<OrderVO> selectAll() throws OrderException {
        List<OrderVO> list = null;
    ...
    @Override
    public List<OrderViewVO> selectAllOrderByUser(int page, int pageSize, int userId, String type) throws OrderException {
    ...
    @Override
    public List<OrderViewVO> selectAllOrderByStore(int page, int pageSize, int storeId, String type) throws OrderException {
        List<OrderViewVO> list = null;
        String sql = null;
        String NULL_CHECK = null;
        String ORDER_BY = null;
