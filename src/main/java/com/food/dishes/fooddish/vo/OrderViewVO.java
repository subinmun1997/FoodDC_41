...
public class OrderViewVO implements Serializable {
    ...
    public OrderViewVO(int orderId, int storeId, int userId, Timestamp order_order_date, Timestamp order_reserve_date, Timestamp order_pickup_date, int price, String storeName, String userName) {
